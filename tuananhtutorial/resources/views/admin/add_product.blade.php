                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_price" class="form-control" id="exampleInputEmail1" placeholder="Nhập giá bán sản phẩm">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8" class="form-control" name="product_content" id="exampleInputPassword1" placeholder="Chi tiết sản phẩm">
                                    </textarea>
                                </div>
